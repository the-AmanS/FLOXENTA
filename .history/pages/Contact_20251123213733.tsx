          ...
          <div className="space-y-12 mb-16">
            ...
            >
               ...
               <div className="ml-6">
                 ...
                 <p className="text-slate-600 dark:text-slate-400 text-lg">hello@floxenta.com</p>
            ...
            >
               ...
               <div className="ml-6">
                 ...
                 <p className="text-slate-600 dark:text-slate-400 text-lg">+91 </p>
            ...
            >
               ...
               <div className="ml-6">
                 ...
                 <p className="text-slate-600 dark:text-slate-400 text-lg">123 Tech Blvd, Suite 400</p>
