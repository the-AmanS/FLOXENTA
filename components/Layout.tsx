      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div variants={item}>
            ...
            <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
              <li className="flex items-center group"><Mail className="w-4 h-4 mr-2 group-hover:text-brand-start group-hover:animate-bounce" /> dev.amansingh1@gmail.com</li>
              <li className="flex items-center group"><MapPin className="w-4 h-4 mr-2 group-hover:text-brand-end group-hover:animate-bounce" /> Mumbai, Maharashtra, India</li>
            </ul>
          </motion.div>
